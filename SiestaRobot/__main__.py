...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by joining @Anime_Gaming_chat_global \
    ...
    if query.data == "siesta_":
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text=gs(chat.id, "support_chat_link_button"), url="https://t.me/Anime_Gaming_chat_global"),
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton(text="SEMPAI", url="https://t.me/callmesenpaibish"),
                    ],
                    [
                        InlineKeyboardButton(text=gs(chat.id, "back_button"), callback_data="siesta_"),
                    ]
